...
?>  
    ...
    <div class="container-fluid bg-danger txt-banner"> <!-- Start Text Banner -->
        <div class="row bottom-banner">
          ...
          <div class="col-sm">
            <h5><i class="fas fa-rupee-sign mr-3"></i> Worth Your Money</h5>
          </div>
        </div>
    </div> <!-- End Text Banner -->
    ...
    ?>  
     ...
     <!-- Start Students Testimonial -->
      <div class="container-fluid mt-5" style="background-color: #4B7289" id="Feedback">
        <h1 class="text-center testyheading p-4">Build Your Future With Us!</h1>
        <div class="row">
          <div class="col-md-12">
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          <div class="col-sm">
            <h5>About Us</h5>
              <p>eLMS provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
          </div>
          <div class="col-sm">
            <h5>Category</h5>
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>eLMS<br>VESIT<br> Chembur,Mumbai<br> Ph. 000000000 </p>
          </div>
        </div>
      </div>
